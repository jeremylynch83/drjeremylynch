/* ==========================================================
   Menu + Navigation behaviour (desktop mega + mobile accordion)
   - Desktop opens on hover/focus. Clicks are ignored on desktop.
   - Hovering a different top item clears any stuck states.
   - Mobile uses collapse + accordion with body lock and backdrop.
   ========================================================== */
...
const menus = [
  // Book
  {
    ...
    sections: [
      ...
      {
        header: "Hospitals & Locations",
        links: [
          {
            label: "The Wellington Hospital",
            href: "Locations_The_Wellington_Hospital.html",
          },
          {
            label: "King’s College Hospital",
            href: "Locations_Kings_College_Hospital.html",
          },
          {
            label: "Queen’s Hospital Romford",
            href: "Locations_Queens_Hospital_in_Romford.html",
          },
        ],
      },
      {
        ...
        links: [
          { label: "Cancellations", href: "General_Cancellations.html" },
          {
            ...
            href: "General_Terms_and_Conditions.html",
          },
        ],
      },
    ],
  ...
  // About
  {
    ...
    sections: [
      {
        header: "About Dr Lynch",
        links: [{ label: "Profile", href: "General_About_Dr_Lynch.html" }],
      },
      {
        header: "Research",
        links: [
        ...
        links: [
          {
            ...
            href: "Aneurysms_Introduction_to_brain_aneurysms.html",
          },
          { label: "AVMs", href: "AVM_Introduction_to_AVMs.html" },
          {
            label: "Dural Fistulas (DAVFs)",
            href: "DAVF_Introduction_to_DAVF.html",
          },
          { label: "Stroke", href: "Stroke_Introduction_to_stroke.html" },
          {
            label: "Pulsatile Tinnitus",
            href: "Pulsatile_Tinnitus_Introduction_to_Pulsatile_Tinnitus.html",
          },
          {
          ...
          },
          {
            ...
            href: "Spontaneous_Intracranial_Hypotension_Introduction_to_Spontaneous_Intracranial_Hypotension.html",
          },
        ],
      },
      {
        ...
        links: [
          {
            label: "Spinal Vascular Disease",
            href: "Spinal_Introduction_to_spinal_vascular_disease.html",
          },
        ],
      },
      {
        header: "Diagnostics",
        links: [
          { label: "MRI", href: "MRI_scans_Introduction_to_MRI_scans.html" },
          { label: "CT", href: "CT_scans_Introduction_to_CT_scans.html" },
          {
            label: "Cerebral Angiography",
            href: "Angiography_Cerebral_angiography.html",
          },
          {
            label: "Spinal Angiography",
            href: "Angiography_Spinal_angiography.html",
          },
        ],
      },
    ],
  ...
  // Articles
  {
    ...
    sections: [
      ...
      {
        header: "Essential Knowledge",
        links: [
          {
            label: "About the Brain",
            href: "Essential_knowledge_About_the_brain.html",
          },
          {
            label: "About the Spine",
            href: "Essential_knowledge_About_the_spine.html",
          },
  ...
  .map((menu, idx) => {
    ...
    return `
      <li class="nav-item dropdown">
        <!-- No data-bs-toggle to prevent Bootstrap click toggling -->
        <a class="nav-link px-3" href="#" id="top${idx}" role="button" aria-haspopup="true" aria-expanded="false">
          ${menu.label}
        </a>
                ...
                <div class="col mega-col mb-3">
                  ...
                  ${s.links
                    .map((l) => {
                      ...
                      return `<a class="link-body-emphasis text-decoration-none d-block py-1" href="${l.href}" ${
...
mobile.addEventListener("click", (e) => {
  ...
  if (!a) return;
  const inst = bootstrap.Collapse.getOrCreateInstance(mobileNavEl, {
    toggle: false,
  });
  inst.hide();
});
...
mobileNavEl.addEventListener("hide.bs.collapse", (e) => {
  ...
  document
    .querySelectorAll(`#${accordionId} .accordion-collapse.show`)
    .forEach((p) => {
...
if (here) {
  ...
  if (match) {
    ...
    const inst = bootstrap.Collapse.getOrCreateInstance(panel, {
      toggle: false,
    });
    inst.show();
  }
